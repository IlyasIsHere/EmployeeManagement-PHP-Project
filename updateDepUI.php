...
<body>
    <h1 class="m-3">Changer le departement d'un employé</h1>
    <form class="form m-3" method="POST" action="updateDep.php">
        ...
        <div class="form-group mt-3">
            <label for="titre" class="form-label">Nouveau département</label>
            <?php
    ...
    if (isset($_GET["success"])) {
        $suc = $_GET["success"];
        if ($suc == "true") { ?>
    <div class="text-white bg-success m-3 p-3">Succès.</div>
        <?php }
        elseif ($suc == "false1") { ?>
